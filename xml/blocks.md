...
To modify the name, description, price, etc of blocks, you must use [ItemData.xml](/xml/items#itemdataxml) with the desired Block ID as the Item ID.
...
### BlockID: [Block](/xml/data-types#block)
...
### Opacity: [byte](/xml/data-types#byte)
...
### Resistance: [ushort](/xml/data-types#ushort)
...
### BaseEfficiency: [ushort](/xml/data-types#ushort)
